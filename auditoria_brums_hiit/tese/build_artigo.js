...
children.push(P('Em atletas de handebol de elite submetidos a um microciclo com HIIT, a evidência convergente das camadas analíticas — cada hipótese testada e sustentada — permite cinco conclusões e uma recomendação aplicada:'));
children.push(P([bold('(1) Resposta específica no eixo energia–fadiga (H1, H2). '), run('O microciclo eleva a fadiga (sobretudo física, dz ≈ 1,0) e reduz o vigor, sem inflar as dimensões negativas; a inércia destas é efeito piso — limitação de medida, não ausência de fenômeno (H3).')]));
