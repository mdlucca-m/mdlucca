...
D['qual']=json.load(open(os.path.join(RAIZ,"dados","V2_qual.json")))
D['conf']=json.load(open(os.path.join(RAIZ,"dados","V2_conf.json")))
D['otim']=json.load(open(os.path.join(RAIZ,"dados","V2_otim.json")))
D['proto']=json.load(open(os.path.join(RAIZ,"dados","V2_proto.json")))
D['cruz']=json.load(open(os.path.join(RAIZ,"dados","V2_cruz.json")))
D['assoc']=json.load(open(os.path.join(RAIZ,"dados","V2_assoc.json")))
D['decomp']=json.load(open(os.path.join(RAIZ,"dados","V2_decomp.json")))
