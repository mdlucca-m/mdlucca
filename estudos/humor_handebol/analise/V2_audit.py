...
UNID=[
 ...
 dict(sigla='U-AD', nome='Par atleta-dia', n=166,
      regra='Um valor por atleta e por dia. D1 teve coleta única e vale a primeira resposta de cada '
            'atleta; de D2 a D7 o valor é a média do primeiro registro do dia (pré) e do último (pós).',
