...
def run():
    ...
    gens = {"DIM": gen_DIM(), "D17": gen_D17(), "FRIED": gen_FRIED(),
            ...
            "CROSS": f"const CROSS={gen_CROSS()}", "CURVE_CROSS": f"const CURVE_CROSS={gen_CROSS()}", "MV": gen_MV(), "SENSV": gen_SENSV(), "HVS": gen_HVS(), "SENSA": gen_SENSA(), "IOTPRED": gen_IOTPRED(), "DERIV": gen_DERIV(), "TRI": gen_TRI(), "TWO": gen_TWO(), "NORMSTD": gen_NORM(), "TRICONF": gen_TRICONF(), "FAC": gen_FAC(), "DYN": gen_DYN(), "LOAD": gen_LOAD(), "DOSE": gen_DOSE(), "STR": gen_STR()}
