...
GOLD = ["athlete_day", "daily_group", "acute_prepos", "risk_features",
        ...
        "an_models", "an_roc", "an_negatives_bydaytype", "an_negatives_mix", "an_icc", "an_omega", "an_thresholds", "an_variance", "an_variance_curves", "an_transitions", "an_risk_profiles", "an_allometry", "an_pvmodel", "risk_features"]
