...
GOLD = ["athlete_day", "daily_group", "acute_prepos", "risk_features",
        ...
        "an_two_omnibus", "an_two_dunnett", "an_two_daytype", "an_two_mixed", "an_two_payload", "an_norm_prev", "an_norm_ref", "an_norm_payload", "an_tric_acute", "an_tric_contrast", "an_tric_payload", "an_fac_cells", "an_fac_rm", "an_fac_mixed", "an_fac_payload", "an_ar1", "an_glm", "an_dyn_payload", "an_sessoes", "an_carga_dia", "an_load_payload", "an_dose", "an_dose_payload", "an_str_desc", "an_str_tri", "an_str_wb", "an_str_prof", "an_str_corr", "an_pv_log", "an_logit", "an_str_payload", "an_rsm", "an_rsm_payload", "an_net_nodes", "an_net_edges", "an_clpm", "an_net_payload", "an_multiplicity", "an_mult_payload", "an_game", "an_game_payload", "risk_features"]
...
def main():
    ...
    import ingest, dbt_run, analytics, analytics_physical, analytics_panel, analytics_tri, analytics_twopaths, analytics_norm, analytics_tri_confirm, analytics_factorial, analytics_dynamics, analytics_load, analytics_doseresp, analytics_strata
    ingest.run(); dbt_run.run(); analytics.run(); analytics_physical.run(); analytics_panel.run(); analytics_tri.run(); analytics_twopaths.run(); analytics_norm.run(); analytics_tri_confirm.run(); analytics_factorial.run(); analytics_dynamics.run(); analytics_load.run(); analytics_doseresp.run(); analytics_strata.run()
    s2 = sig_all()
