...
GOLD = ["athlete_day", "daily_group", "acute_prepos", "risk_features",
        ...
        "an_two_omnibus", "an_two_dunnett", "an_two_daytype", "an_two_mixed", "an_two_payload", "an_norm_prev", "an_norm_ref", "an_norm_payload", "an_tric_acute", "an_tric_contrast", "an_tric_payload", "an_fac_cells", "an_fac_rm", "an_fac_mixed", "an_fac_payload", "an_ar1", "an_glm", "an_dyn_payload", "risk_features"]
...
def main():
    ...
    import ingest, dbt_run, analytics, analytics_physical, analytics_panel, analytics_tri, analytics_twopaths, analytics_norm, analytics_tri_confirm, analytics_factorial, analytics_dynamics
    ingest.run(); dbt_run.run(); analytics.run(); analytics_physical.run(); analytics_panel.run(); analytics_tri.run(); analytics_twopaths.run(); analytics_norm.run(); analytics_tri_confirm.run(); analytics_factorial.run(); analytics_dynamics.run()
    s2 = sig_all()
