...
K.push(P("A distribuição dos perfis ao longo dos dias revela a conexão com o tipo de estímulo. A Tabela 8 apresenta a prevalência diária de cada perfil, e a Figura 6 destaca os perfis mais reativos. A barbatana de tubarão cresce ao longo da semana e atinge o pico no sétimo dia, coerente com a sobrecarga física acumulada, ainda que a superfície permaneça o perfil mais frequente ao final do microciclo. O submerso comparece com mais força nos dias de jogo, padrão compatível com o recolhimento afetivo que segue o desgaste competitivo."));
