...
A reanálise foi reexecutada em Python (numpy, scipy, statsmodels) sobre os dados item a item (24 itens do BRUMS) e sobre a carga interna das três sessões de HIIT. Os valores recomputados **convergem com — e em vários pontos reproduzem exatamente** — os do relatório original, o que sustenta a fidedignidade dos resultados.
