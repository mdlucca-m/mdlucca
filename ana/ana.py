...
def main() -> int:
    ...
    cz = sp.add_parser("cruzamento")
    cz.add_argument("--par", default="todos", choices=["Vigor×Fadiga","Vigor×TMD","Fadiga×TMD","todos"])
    cz.add_argument("--parte", default="tudo", choices=["filtro","cruzamentos","tudo"])
    dc = sp.add_parser("decomposicao")
    dc.add_argument("--parte", default="tudo", choices=["componentes","serie","deslocamento","filtro","tudo"])
    dc.add_argument("--variavel")
    pr = sp.add_parser("protocolo")
    pr.add_argument("--parte", default="tudo", choices=["janelas","regra","excedentes","impacto","tudo"])
