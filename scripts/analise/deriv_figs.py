...
f=make_subplots(rows=1,cols=2,subplot_titles=[p[1] for p in PAN],
    specs=[[{'secondary_y':True},{'secondary_y':True}]],horizontal_spacing=0.11)
...
f.update_layout(template='plotly_white',font=dict(color='#1a1a1a',size=14,family='Arial'),
    paper_bgcolor='white',plot_bgcolor='white',margin=dict(l=60,r=60,t=64,b=52),width=1040,height=440,
