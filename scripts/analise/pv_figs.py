...
for i,c in enumerate(cols):
    ...
    f.add_trace(go.Scatter(x=xs,y=ys,mode='lines',line=dict(color=HEX[c],width=4.3),showlegend=False),r,cc)
...
f.add_trace(go.Scatter(x=xs,y=ys,mode='lines',line=dict(color=HEX[c],width=5.1),showlegend=False))
